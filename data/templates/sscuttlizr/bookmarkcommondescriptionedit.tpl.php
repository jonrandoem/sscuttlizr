	...
	<div class="row">
		<div class="col-12 col-xs-12 col-sm-12 col-lg-12">
			...
			<tr>
					...
					<td><input class="form-control" type="text" id="title" name="title" size="75" maxlength="255" value="<?php echo $description['cdTitle']; ?>" onkeypress="this.style.backgroundImage = 'none';" /></td>
					<td></td>
			</tr>
			<tr>
